...
if(!memcpy.binding){
    console.warn('WARNING from nw-f2cwa-play: node-memcpy module is probably not compiled with nw-gyp. please compile node-memcpy with nw-gyp for your nw version to get maximum performance!');
}
