...
Renderer.prototype._newVideoFrame = function(buf){
    ...
    var
        ...
        e, i, l=buf.length;
    if(!this.prevTimeStamp) this.prevTimeStamp = window.performance.now();
...
Renderer.prototype._renderer = function(){
    ...
    while(this.frames.length && this.frames[0].timeStamp<=now) {
...
Renderer.prototype._newAudioBuffer = function(buf){
    var bufAsUint8Arr = new window.Uint8Array(buf),
